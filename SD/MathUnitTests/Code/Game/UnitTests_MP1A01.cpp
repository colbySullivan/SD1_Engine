...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A01_Vec2Construction()
{
#if defined( ENABLE_TestSet_MP1A01_Vec2Construction )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A01_Vec2TemporaryOperators()
{
#if defined( ENABLE_TestSet_MP1A01_Vec2TemporaryOperators )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A01_Vec2ComparisonOperators()
{
#if defined( ENABLE_TestSet_MP1A01_Vec2ComparisonOperators )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A01_Vec2AssignmentOperators()
{
#if defined( ENABLE_TestSet_MP1A01_Vec2AssignmentOperators )
...
//-----------------------------------------------------------------------------------------------
void RunTests_MP1A01()
{
	RunTestSet(true, TestSet_MP1A01_Vec2Construction, "MP1-A01: Vec2 construction");
	RunTestSet(true, TestSet_MP1A01_Vec2TemporaryOperators, "MP1-A01: Vec2 temp operators");
	RunTestSet(true, TestSet_MP1A01_Vec2ComparisonOperators, "MP1-A01: Vec2 comparison operators");
	RunTestSet(true, TestSet_MP1A01_Vec2AssignmentOperators, "MP1-A01: Vec2 assignment operators");
}
